        ...
        return (
            <Fragment>
                <CText style={[GlobalStyle.listTitle, GlobalStyle.marginHorizontal_0]}>
                    {t('PAY_BILL.SELECT')} {slug === 'mobile_prepaid' ? t('PAY_BILL.PACKAGE') : t('PAY_BILL.SERVICES')}
                </CText>
            </Fragment>
        )
    };
        ...
        <Container
           ...
           <CList
                ...
                emptyOptions={{
                    ...
                    text: `${t('PAY_BILL.NO')} ${slug === 'mobile_prepaid' ? t('PAY_BILL.PACKAGES') : t('PAY_BILL.SERVICES')} ${t('PAY_BILL.FOUND')}`
                }}
            />
        </Container>
    )
