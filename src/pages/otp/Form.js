...
function CForm(props) {
    ...
    const {submit, loading, resendCode, otp = '', reSendShow} = props;
            ...
            {({handleChange, values, handleSubmit, errors, setFieldValue}) => {
                return (
                    <View style={Styles.formContainer}>
                        ...
                        {reSendShow ? <CountDownTimer text={t('GLOBAL.REQUEST_A_NEW_CODE_IN')}>
                            <TouchableOpacity style={Styles.linkButtonWithIcon}
                                              onPress={() => loading ? null : again()}>
