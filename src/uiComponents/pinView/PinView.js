        ...
        <TouchableOpacity
            ...
            <View
                ...
                {customComponent ? (
                    ...
                    <CText style={[PinViewStyle.buttonText, customTextStyle]}>{text}</CText>
                )}
            </View>
        </TouchableOpacity>
    )
...
const ViewInput = ({
                       ...
                       customStyle,
                       text,
                       inputFilledStyle = PinViewStyle.inputFilledStyle,
                       inputEmptyStyle = PinViewStyle.inputEmptyStyle,
                   }) => {
    if (showInputText) {
        return (
            <View
                ...
                <CText style={[PinViewStyle.inputText, inputTextStyle]}>{text}</CText>
            </View>
        )
    } else {
        return (
    ...
    (
        {
            ...
            customLeftButtonSize = 72,
            customRightButtonSize = 72,
        },
        ref
    ) => {
        ...
        return (
            <View style={[PinViewStyle.pinView, style]}>
                <View style={[PinViewStyle.inputContainer, {height: 20}, inputAreaStyle]}>
                ...
                <View style={[PinViewStyle.buttonAreaContainer, buttonAreaStyle]}>
                    ...
                    {customLeftButton !== undefined ? (
                        <ViewButton
                            ...
                            customViewStyle={{...customLeftButtonViewStyle, borderBottomWidth: 0}}
                    ...
                    {customRightButton !== undefined ? (
                        <ViewButton
                            ...
                            customViewStyle={{...customRightButtonViewStyle, borderBottomWidth: 0}}
